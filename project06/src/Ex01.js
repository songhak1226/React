...
/* rcc : class component 생성하는 단축키
    ...
    Function 컴포넌트에서 실행되지 않았던 리액트의 중요 요소들을
    Function 컴포넌트에서 사용할 수 있게 됨

    ex) LifeCycle같은 중요한 개념을 Function Component에서 사용할 수 없었음
        React Hook이 생겨나게 되면서 이제는 Function Component에서도 
